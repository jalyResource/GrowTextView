...
Pod::Spec.new do |s|
  s.name             = 'GrowTextView'
  s.version          = '0.1.0'
  s.summary          = 'A short description of GrowTextView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/wuzhenli/GrowTextView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'wuzhenli' => 'zhenli@6.cn' }
  s.source           = { :git => 'https://github.com/wuzhenli/GrowTextView.git', :tag => s.version.to_s }
